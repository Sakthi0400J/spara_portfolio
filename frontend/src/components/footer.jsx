    ...
    return (
      ...
      <footer className="footer">
        ...
        <div className="footer-container">
          ...
          <div className="footer-col contact">
            ...
            <p>
              ...
              <a href="mailto:sparatechnotex@gmail.com" style={{ color: '#ffffff' }}>sparatechnotex@gmail.com</a>
            </p>
        ...
        <div className="footer-bottom">
          ...
          <p>
            <span style={{ fontSize: '1.4em', verticalAlign: 'middle' }}>©</span> Spara Technotex. All rights reserved.
          </p>
          ...
          >
            ...
            >
              ...
              <a href="https://tridentarctechathon.com/"target="_blank" 
      rel="noopener noreferrer" style={{ color: '#ffffff' }}>TridentArc</a>
